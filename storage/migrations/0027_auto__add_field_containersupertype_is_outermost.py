...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerSupertype.is_outermost'
        db.add_column(u'storage_containersupertype', 'is_outermost',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContainerSupertype.is_outermost'
        db.delete_column(u'storage_containersupertype', 'is_outermost')
    ...
    models = {
        ...
        u'storage.container': {
            'Meta': {'ordering': "['type', 'name']", 'object_name': 'Container'},
        ...
        u'storage.containersupertype': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_outermost': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
