...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vector.created_by2'
        db.delete_column(u'vectors_vector', 'created_by2_id')

        # Adding field 'Vector.created_by'
        db.add_column(u'vectors_vector', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Vector.created_by2'
        db.add_column(u'vectors_vector', 'created_by2',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Deleting field 'Vector.created_by'
        db.delete_column(u'vectors_vector', 'created_by_id')
