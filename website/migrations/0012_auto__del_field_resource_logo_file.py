...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Resource.logo_file'
        db.delete_column(u'website_resource', 'logo_file')


    def backwards(self, orm):
        # Adding field 'Resource.logo_file'
        db.add_column(u'website_resource', 'logo_file',
