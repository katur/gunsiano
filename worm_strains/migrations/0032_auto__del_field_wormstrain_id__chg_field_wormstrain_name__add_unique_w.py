...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WormStrain.id'
        db.delete_column(u'worm_strains_wormstrain', u'id')
        ...
        # Deleting field 'WormStrainLine.strain'
        db.delete_column(u'worm_strains_wormstrainline', 'strain_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'WormStrain.id'
        db.add_column(u'worm_strains_wormstrain', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)


        # Changing field 'WormStrain.name'
        db.alter_column(u'worm_strains_wormstrain', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Adding field 'WormStrainLine.strain'
        db.add_column(u'worm_strains_wormstrainline', 'strain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['worm_strains.WormStrain']),
                      keep_default=False)
    ...
    models = {
        ...
        u'worm_strains.wormstrainline': {
            ...
            'strain_name': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
