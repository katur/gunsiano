...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.url_name'
        db.add_column(u'website_person', 'url_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.url_name'
        db.delete_column(u'website_person', 'url_name')
    ...
    models = {
        u'website.person': {
            ...
            'url_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
