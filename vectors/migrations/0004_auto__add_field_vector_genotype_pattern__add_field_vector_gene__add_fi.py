...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vector.genotype_pattern'
        db.add_column(u'vectors_vector', 'genotype_pattern',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Vector.gene'
        db.add_column(u'vectors_vector', 'gene',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Vector.promoter'
        db.add_column(u'vectors_vector', 'promoter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Vector.three_prime_utr'
        db.add_column(u'vectors_vector', 'three_prime_utr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vector.genotype_pattern'
        db.delete_column(u'vectors_vector', 'genotype_pattern')

        # Deleting field 'Vector.gene'
        db.delete_column(u'vectors_vector', 'gene')

        # Deleting field 'Vector.promoter'
        db.delete_column(u'vectors_vector', 'promoter')

        # Deleting field 'Vector.three_prime_utr'
        db.delete_column(u'vectors_vector', 'three_prime_utr')
