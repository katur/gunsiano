...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResearchArea.filename'
        db.delete_column(u'website_researcharea', 'filename')


    def backwards(self, orm):
        # Adding field 'ResearchArea.filename'
        db.add_column(u'website_researcharea', 'filename',
