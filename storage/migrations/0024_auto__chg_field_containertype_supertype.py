...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContainerType.supertype'
        db.alter_column(u'storage_containertype', 'supertype_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['storage.ContainerSupertype']))

    def backwards(self, orm):

        # Changing field 'ContainerType.supertype'
        db.alter_column(u'storage_containertype', 'supertype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.ContainerSupertype'], null=True))
