...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WormStrainLine', fields ['stockable']
        db.create_unique(u'worm_strains_wormstrainline', ['stockable_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WormStrainLine', fields ['stockable']
        db.delete_unique(u'worm_strains_wormstrainline', ['stockable_id'])
    ...
    models = {
        ...
        u'worm_strains.wormstrainline': {
            ...
            'remarks': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'stockable': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['storage.Stockable']", 'unique': 'True'}),
