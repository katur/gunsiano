...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WormStrain.genotype_code'
        db.add_column(u'worm_strains_wormstrain', 'genotype_code',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WormStrain.genotype_code'
        db.delete_column(u'worm_strains_wormstrain', 'genotype_code')
