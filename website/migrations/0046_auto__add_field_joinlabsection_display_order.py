...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JoinLabSection.display_order'
        db.add_column(u'website_joinlabsection', 'display_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JoinLabSection.display_order'
        db.delete_column(u'website_joinlabsection', 'display_order')
    ...
    models = {
        ...
        u'website.joinlabsection': {
            'Meta': {'object_name': 'JoinLabSection'},
