...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WormSpecies', fields ['name']
        db.create_unique(u'worm_strains_wormspecies', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'WormSpecies', fields ['name']
        db.delete_unique(u'worm_strains_wormspecies', ['name'])
