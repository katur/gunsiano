...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_publication', 'journal', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Publication.detail'
        db.alter_column(u'website_publication', 'detail', self.gf('django.db.models.fields.CharField')(max_length=60))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Publication.detail'
        db.alter_column(u'website_publication', 'detail', self.gf('django.db.models.fields.CharField')(max_length=50))
