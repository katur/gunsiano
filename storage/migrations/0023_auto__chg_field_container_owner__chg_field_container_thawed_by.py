...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Container.owner'
        db.alter_column(u'storage_container', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Container.thawed_by'
        db.alter_column(u'storage_container', 'thawed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Container.owner'
        db.alter_column(u'storage_container', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.UserProfile'], null=True))

        # Changing field 'Container.thawed_by'
        db.alter_column(u'storage_container', 'thawed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['website.UserProfile']))
    ...
    models = {
        ...
        u'storage.container': {
            ...
            'thawed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'container_thawed_by'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'storage.stock': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'prepared_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
