...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'WormStrain', fields ['strain_sort']
        db.create_unique(u'worm_strains_wormstrain', ['strain_sort'])


    def backwards(self, orm):
        # Removing unique constraint on 'WormStrain', fields ['strain_sort']
        db.delete_unique(u'worm_strains_wormstrain', ['strain_sort'])
