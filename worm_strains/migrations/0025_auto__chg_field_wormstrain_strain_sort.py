...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WormStrain.strain_sort'
        db.alter_column(u'worm_strains_wormstrain', 'strain_sort', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

    def backwards(self, orm):

        # Changing field 'WormStrain.strain_sort'
        db.alter_column(u'worm_strains_wormstrain', 'strain_sort', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
