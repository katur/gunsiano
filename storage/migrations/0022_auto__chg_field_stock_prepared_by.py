...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stock.prepared_by'
        db.alter_column(u'storage_stock', 'prepared_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Stock.prepared_by'
        db.alter_column(u'storage_stock', 'prepared_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.UserProfile'], null=True))
