...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.display_on_website'
        db.add_column(u'website_userprofile', 'display_on_website',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.display_on_website'
        db.delete_column(u'website_userprofile', 'display_on_website')
    ...
    models = {
        ...
        u'website.position': {
            'Meta': {'ordering': "['display_order', 'position']", 'object_name': 'Position'},
            'display_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.userprofile': {
            ...
            'display_on_website': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
