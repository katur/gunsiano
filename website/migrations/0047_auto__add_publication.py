...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_publication', (
            ...
            ('journal', self.gf('django.db.models.fields.CharField')(max_length='200', blank=True)),
            ('date', self.gf('django.db.models.fields.CharField')(max_length='30', blank=True)),
            ('details', self.gf('django.db.models.fields.CharField')(max_length='50', blank=True)),
        ))
    ...
    models = {
        ...
        u'website.publication': {
            ...
            'details': ('django.db.models.fields.CharField', [], {'max_length': "'50'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
