...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'storage_containertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('supertype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.ContainerSupertype'], null=True)),
            ('slots_vertical', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('slots_horizontal', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('image_filename', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
        ))
        db.send_create_signal(u'storage', ['ContainerType'])


        # Changing field 'ContainerSupertype.name'
        db.alter_column(u'storage_containersupertype', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting model 'ContainerType'
        db.delete_table(u'storage_containertype')


        # Changing field 'ContainerSupertype.name'
        db.alter_column(u'storage_containersupertype', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
