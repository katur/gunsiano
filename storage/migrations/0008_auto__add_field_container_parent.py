...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.parent'
        db.add_column(u'storage_container', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Container'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.parent'
        db.delete_column(u'storage_container', 'parent_id')
