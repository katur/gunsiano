...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.mislabeled_as'
        db.add_column(u'storage_container', 'mislabeled_as',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.mislabeled_as'
        db.delete_column(u'storage_container', 'mislabeled_as')
