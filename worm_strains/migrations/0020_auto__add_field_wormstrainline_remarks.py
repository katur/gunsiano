...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WormStrainLine.remarks'
        db.add_column(u'worm_strains_wormstrainline', 'remarks',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WormStrainLine.remarks'
        db.delete_column(u'worm_strains_wormstrainline', 'remarks')
