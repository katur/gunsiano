...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WormLab'
        db.create_table(u'worm_strains_wormlab', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lab', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('strain_code', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('allele_code', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
        ))
        db.send_create_signal(u'worm_strains', ['WormLab'])


    def backwards(self, orm):
        # Deleting model 'WormLab'
        db.delete_table(u'worm_strains_wormlab')
    ...
    models = {
        ...
        u'worm_strains.wormstrain': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10', 'blank': 'True'}),
            ...
            'strain_sort': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10', 'blank': 'True'}),
