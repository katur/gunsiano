...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('website_person', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254))

    def backwards(self, orm):

        # Changing field 'Person.email'
        db.alter_column('website_person', 'email', self.gf('django.db.models.fields.CharField')(max_length=100))
