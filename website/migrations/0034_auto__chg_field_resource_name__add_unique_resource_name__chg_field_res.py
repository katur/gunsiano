...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_resource', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))
        # Adding unique constraint on 'Resource', fields ['name']
        db.create_unique(u'website_resource', ['name'])


        # Changing field 'ResearchArea.name'
        db.alter_column(u'website_researcharea', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60))

    def backwards(self, orm):
        # Removing unique constraint on 'Resource', fields ['name']
        db.delete_unique(u'website_resource', ['name'])


        # Changing field 'Resource.name'
        db.alter_column(u'website_resource', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'ResearchArea.name'
        db.alter_column(u'website_researcharea', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
    ...
    models = {
        ...
        u'website.researcharea': {
            ...
            'display_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'unique': 'True'}),
            'filename': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50', 'blank': 'True'}),
            'filename_is_video': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
