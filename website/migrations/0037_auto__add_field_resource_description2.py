...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.description2'
        db.add_column(u'website_resource', 'description2',
                      self.gf('django.db.models.fields.TextField')(default='asdf'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.description2'
        db.delete_column(u'website_resource', 'description2')
