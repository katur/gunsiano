...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.display_order'
        db.add_column(u'website_resource', 'display_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.display_order'
        db.delete_column(u'website_resource', 'display_order')
