...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Protocol.author2'
        db.add_column(u'protocols_protocol', 'author2',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


        # Changing field 'Protocol.pub_date'
        db.alter_column(u'protocols_protocol', 'pub_date', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):
        # Deleting field 'Protocol.author2'
        db.delete_column(u'protocols_protocol', 'author2_id')


        # Changing field 'Protocol.pub_date'
        db.alter_column(u'protocols_protocol', 'pub_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'protocols.protocol': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['website.UserProfile']", 'null': 'True'}),
            'author2': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
