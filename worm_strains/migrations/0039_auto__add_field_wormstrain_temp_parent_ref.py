...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WormStrain.temp_parent_ref'
        db.add_column(u'worm_strains_wormstrain', 'temp_parent_ref',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WormStrain.temp_parent_ref'
        db.delete_column(u'worm_strains_wormstrain', 'temp_parent_ref')
