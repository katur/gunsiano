...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publication.details'
        db.delete_column(u'website_publication', 'details')

        # Adding field 'Publication.detail'
        db.add_column(u'website_publication', 'detail',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Publication.abstract'
        db.add_column(u'website_publication', 'abstract',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


        # Changing field 'Publication.journal'
        db.alter_column(u'website_publication', 'journal', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Publication.date'
        db.alter_column(u'website_publication', 'date', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Adding field 'Publication.details'
        db.add_column(u'website_publication', 'details',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='50', blank=True),
                      keep_default=False)

        # Deleting field 'Publication.detail'
        db.delete_column(u'website_publication', 'detail')

        # Deleting field 'Publication.abstract'
        db.delete_column(u'website_publication', 'abstract')
    ...
    models = {
        ...
        u'website.publication': {
            ...
            'abstract': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'journal': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
