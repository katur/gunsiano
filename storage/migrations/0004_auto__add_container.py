...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'storage_container', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vertical_position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('horizontal_position', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True)),
            ('stock', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Stock'], null=True)),
        ))
        db.send_create_signal(u'storage', ['Container'])


    def backwards(self, orm):
        # Deleting model 'Container'
        db.delete_table(u'storage_container')
