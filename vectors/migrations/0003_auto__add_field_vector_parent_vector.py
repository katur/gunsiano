...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vector.parent_vector'
        db.add_column(u'vectors_vector', 'parent_vector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vectors.Vector'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vector.parent_vector'
        db.delete_column(u'vectors_vector', 'parent_vector_id')
