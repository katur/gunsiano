...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.in_abu_dhabi'
        db.add_column('website_person', 'in_abu_dhabi',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.in_abu_dhabi'
        db.delete_column('website_person', 'in_abu_dhabi')
