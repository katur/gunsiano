...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.logo_filename'
        db.add_column(u'website_resource', 'logo_filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.logo_filename'
        db.delete_column(u'website_resource', 'logo_filename')
