...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WormStrain.stockable'
        db.delete_column(u'worm_strains_wormstrain', 'stockable_id')

        # Adding field 'WormStrainLine.stockable'
        db.add_column(u'worm_strains_wormstrainline', 'stockable',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Stockable'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WormStrain.stockable'
        db.add_column(u'worm_strains_wormstrain', 'stockable',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Stockable'], null=True),
                      keep_default=False)

        # Deleting field 'WormStrainLine.stockable'
        db.delete_column(u'worm_strains_wormstrainline', 'stockable_id')
    ...
    models = {
        ...
        u'worm_strains.wormstrain': {
            ...
            'strain_sort': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20', 'blank': 'True'}),
