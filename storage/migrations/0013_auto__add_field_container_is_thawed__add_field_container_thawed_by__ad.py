...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.is_thawed'
        db.add_column(u'storage_container', 'is_thawed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Container.thawed_by'
        db.add_column(u'storage_container', 'thawed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='container_thawed_by', null=True, to=orm['website.UserProfile']),
                      keep_default=False)

        # Adding field 'Container.date_thawed'
        db.add_column(u'storage_container', 'date_thawed',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Container.thaw_results'
        db.add_column(u'storage_container', 'thaw_results',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.is_thawed'
        db.delete_column(u'storage_container', 'is_thawed')

        # Deleting field 'Container.thawed_by'
        db.delete_column(u'storage_container', 'thawed_by_id')

        # Deleting field 'Container.date_thawed'
        db.delete_column(u'storage_container', 'date_thawed')

        # Deleting field 'Container.thaw_results'
        db.delete_column(u'storage_container', 'thaw_results')
    ...
    models = {
        ...
        u'storage.container': {
            ...
            'contents': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
