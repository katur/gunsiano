...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WormStrain.created_by'
        db.alter_column(u'worm_strains_wormstrain', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'WormStrainLine.received_by'
        db.alter_column(u'worm_strains_wormstrainline', 'received_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'WormStrain.created_by'
        db.alter_column(u'worm_strains_wormstrain', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.UserProfile'], null=True))

        # Changing field 'WormStrainLine.received_by'
        db.alter_column(u'worm_strains_wormstrainline', 'received_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.UserProfile'], null=True))
    ...
    models = {
        ...
        u'worm_strains.wormstrainline': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'received_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
            ...
            'strain': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['worm_strains.WormStrain']", 'null': 'True'}),
