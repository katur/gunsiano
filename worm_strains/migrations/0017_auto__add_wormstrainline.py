...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WormStrainLine'
        db.create_table(u'worm_strains_wormstrainline', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('strain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['worm_strains.WormStrain'])),
        ))
        db.send_create_signal(u'worm_strains', ['WormStrainLine'])


    def backwards(self, orm):
        # Deleting model 'WormStrainLine'
        db.delete_table(u'worm_strains_wormstrainline')
