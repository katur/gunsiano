...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WormStrain.strain_sort'
        db.delete_column(u'worm_strains_wormstrain', 'strain_sort')


    def backwards(self, orm):
        # Adding field 'WormStrain.strain_sort'
        db.add_column(u'worm_strains_wormstrain', 'strain_sort',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, unique=True, blank=True),
                      keep_default=False)
