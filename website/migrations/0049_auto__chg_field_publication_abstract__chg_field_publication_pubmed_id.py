...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Publication.abstract'
        db.alter_column(u'website_publication', 'abstract', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Publication.pubmed_id'
        db.alter_column(u'website_publication', 'pubmed_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Publication.abstract'
        db.alter_column(u'website_publication', 'abstract', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Publication.pubmed_id'
        db.alter_column(u'website_publication', 'pubmed_id', self.gf('django.db.models.fields.IntegerField')(null=True))
