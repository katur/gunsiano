...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ResearchArea', fields ['filename']
        db.delete_unique(u'website_researcharea', ['filename'])

        # Deleting field 'ResearchArea.filename_is_video'
        db.delete_column(u'website_researcharea', 'filename_is_video')


    def backwards(self, orm):
        # Adding field 'ResearchArea.filename_is_video'
        db.add_column(u'website_researcharea', 'filename_is_video',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'ResearchArea', fields ['filename']
        db.create_unique(u'website_researcharea', ['filename'])
    ...
    models = {
        ...
        u'website.researcharea': {
            'Meta': {'ordering': "['display_order']", 'object_name': 'ResearchArea'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'display_order': ('django.db.models.fields.PositiveSmallIntegerField', [], {'unique': 'True'}),
            'filename': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '60'}),
            'style_name': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'})
        },
        u'website.resource': {
