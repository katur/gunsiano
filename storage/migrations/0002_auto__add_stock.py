...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Stock'
        db.create_table(u'storage_stock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stockable', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.Stockable'], null=True)),
            ('concentration', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('prepared_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.UserProfile'], null=True)),
            ('date_prepared', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal(u'storage', ['Stock'])


    def backwards(self, orm):
        # Deleting model 'Stock'
        db.delete_table(u'storage_stock')
