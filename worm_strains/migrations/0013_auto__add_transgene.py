...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Transgene'
        db.create_table(u'worm_strains_transgene', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('vector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vectors.Vector'], null=True)),
        ))
        db.send_create_signal(u'worm_strains', ['Transgene'])


    def backwards(self, orm):
        # Deleting model 'Transgene'
        db.delete_table(u'worm_strains_transgene')
    ...
    models = {
        ...
        u'worm_strains.wormstrain': {
            ...
            'genotype_code': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
