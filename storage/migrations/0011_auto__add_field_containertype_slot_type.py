...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerType.slot_type'
        db.add_column(u'storage_containertype', 'slot_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='container_slot_type', null=True, to=orm['storage.ContainerSupertype']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContainerType.slot_type'
        db.delete_column(u'storage_containertype', 'slot_type_id')
