...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WormStrain.transgene'
        db.add_column(u'worm_strains_wormstrain', 'transgene',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['worm_strains.Transgene'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WormStrain.transgene'
        db.delete_column(u'worm_strains_wormstrain', 'transgene_id')
