...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_person', 'url_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))
    ...
    models = {
        ...
        u'website.person': {
            ...
            'url_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
