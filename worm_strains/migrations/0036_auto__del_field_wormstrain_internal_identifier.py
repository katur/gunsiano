...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WormStrain.internal_identifier'
        db.delete_column(u'worm_strains_wormstrain', 'internal_identifier')


    def backwards(self, orm):
        # Adding field 'WormStrain.internal_identifier'
        db.add_column(u'worm_strains_wormstrain', 'internal_identifier',
