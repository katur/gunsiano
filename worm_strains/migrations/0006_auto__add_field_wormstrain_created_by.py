...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WormStrain.created_by'
        db.add_column(u'worm_strains_wormstrain', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['website.UserProfile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WormStrain.created_by'
        db.delete_column(u'worm_strains_wormstrain', 'created_by_id')
