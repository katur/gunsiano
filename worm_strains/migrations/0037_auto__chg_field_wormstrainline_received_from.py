...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WormStrainLine.received_from'
        db.alter_column(u'worm_strains_wormstrainline', 'received_from', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'WormStrainLine.received_from'
        db.alter_column(u'worm_strains_wormstrainline', 'received_from', self.gf('django.db.models.fields.CharField')(max_length=50))
