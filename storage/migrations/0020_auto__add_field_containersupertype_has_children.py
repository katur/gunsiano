...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContainerSupertype.has_children'
        db.add_column(u'storage_containersupertype', 'has_children',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContainerSupertype.has_children'
        db.delete_column(u'storage_containersupertype', 'has_children')
