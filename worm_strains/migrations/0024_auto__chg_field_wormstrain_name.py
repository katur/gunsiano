...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'worm_strains_wormstrain', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

    def backwards(self, orm):

        # Changing field 'WormStrain.name'
        db.alter_column(u'worm_strains_wormstrain', 'name', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
