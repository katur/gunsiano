...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WormStrain.internal_identifier'
        db.alter_column(u'worm_strains_wormstrain', 'internal_identifier', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'WormStrain.internal_identifier'
        db.alter_column(u'worm_strains_wormstrain', 'internal_identifier', self.gf('django.db.models.fields.CharField')(max_length=20))
