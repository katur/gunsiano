...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stockable.type'
        db.add_column(u'storage_stockable', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['storage.StockableType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stockable.type'
        db.delete_column(u'storage_stockable', 'type_id')
