...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Container.type'
        db.alter_column(u'storage_container', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['storage.ContainerType']))

    def backwards(self, orm):

        # Changing field 'Container.type'
        db.alter_column(u'storage_container', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.ContainerType'], null=True))
