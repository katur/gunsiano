...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WormStrainLine.created_internally'
        db.add_column(u'worm_strains_wormstrainline', 'created_internally',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WormStrainLine.created_internally'
        db.delete_column(u'worm_strains_wormstrainline', 'created_internally')
