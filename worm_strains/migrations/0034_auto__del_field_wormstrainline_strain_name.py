...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WormStrainLine.strain_name'
        db.delete_column(u'worm_strains_wormstrainline', 'strain_name')


    def backwards(self, orm):
        # Adding field 'WormStrainLine.strain_name'
        db.add_column(u'worm_strains_wormstrainline', 'strain_name',
