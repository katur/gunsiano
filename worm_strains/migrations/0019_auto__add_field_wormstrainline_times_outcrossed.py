...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WormStrainLine.times_outcrossed'
        db.add_column(u'worm_strains_wormstrainline', 'times_outcrossed',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WormStrainLine.times_outcrossed'
        db.delete_column(u'worm_strains_wormstrainline', 'times_outcrossed')
