...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContainerSupertype'
        db.create_table(u'storage_containersupertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'storage', ['ContainerSupertype'])


    def backwards(self, orm):
        # Deleting model 'ContainerSupertype'
        db.delete_table(u'storage_containersupertype')
