...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserProfile2'
        db.create_table(u'website_userprofile2', (
        ...
        db.send_create_signal(u'website', ['UserProfile2'])


    def backwards(self, orm):
        # Deleting model 'UserProfile2'
        db.delete_table(u'website_userprofile2')
    ...
    models = {
        ...
        u'website.userprofile2': {
            'Meta': {'ordering': "['net_id']", 'object_name': 'UserProfile2'},
            'blurb': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'image_filename': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'in_abu_dhabi': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'is_current': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
