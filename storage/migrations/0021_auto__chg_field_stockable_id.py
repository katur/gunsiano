...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stockable.id'
        db.alter_column(u'storage_stockable', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Stockable.id'
        db.alter_column(u'storage_stockable', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
