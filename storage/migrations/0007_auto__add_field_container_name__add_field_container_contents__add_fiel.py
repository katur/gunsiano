...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'storage_container', 'name',
        ...
        # Adding field 'Container.type'
        db.add_column(u'storage_container', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.ContainerType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.name'
        db.delete_column(u'storage_container', 'name')

        # Deleting field 'Container.contents'
        db.delete_column(u'storage_container', 'contents')

        # Deleting field 'Container.type'
        db.delete_column(u'storage_container', 'type_id')
